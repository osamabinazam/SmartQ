    ...
    <Box sx={{ width: 70, height: 100, ...sx }}>
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0  120 120  ">
        ...
        <g fill={PRIMARY_MAIN} fillRule="evenodd" stroke="none" strokeWidth="1">
          <path
            fill="url(#BG1)"
            d="M92.85,86.52c-1.27,0.43-2.5,0.89-3.76,1.27c-13.34,3.97-27.68-1.1-34.31-12.09c-0.28-0.46-0.78-0.89-1.3-1.15
            ...
            c-1.01-1.84-2.01-3.64-3.07-5.6c0.87-0.5,1.84-1.12,2.88-1.63c16.32-8.1,36.49-0.81,41.46,15.11c2.47,7.91,0.65,15.23-4.97,21.78
          ...
          <path
            fill="url(#BG2)"
            d="M57.05,81.53c0.55,0.47,1.08,0.91,1.66,1.4c-1.5,1.4-3.26,2.34-5.11,3.17c-6.93,3.11-18.14,2.56-23.93-1.39
